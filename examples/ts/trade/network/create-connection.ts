...
import { CreateNetworkConnectionParams } from 'modules/sdk-core/src/bitgo/trading/network';
...
async function main() {
  ...
  const body: CreateNetworkConnectionParams = {
    payload: '',
    signature: '',
    partnerId: '',
    name: '',
  ...
  const connection = await tradingNetwork.createConnection(body);
