...
function aa(a, b, c) {
  ...
  var t = h[1],
    ...
    D = h[4];
  for (m = 0; m < n; m++)
    (h = a[e >>> 24] ^ t[(f >> 16) & 255] ^ C[(g >> 8) & 255] ^ E[b & 255] ^ d[p]),
      (k = a[f >>> 24] ^ t[(g >> 16) & 255] ^ C[(b >> 8) & 255] ^ E[e & 255] ^ d[p + 1]),
      (l = a[g >>> 24] ^ t[(b >> 16) & 255] ^ C[(e >> 8) & 255] ^ E[f & 255] ^ d[p + 2]),
      (b = a[b >>> 24] ^ t[(e >> 16) & 255] ^ C[(f >> 8) & 255] ^ E[g & 255] ^ d[p + 3]),
      (p += 4),
      (e = h),
      (f = k),
      (g = l);
  for (m = 0; 4 > m; m++)
    (s[c ? 3 & -m : m] =
      (D[e >>> 24] << 24) ^ (D[(f >> 16) & 255] << 16) ^ (D[(g >> 8) & 255] << 8) ^ D[b & 255] ^ d[p++]),
      (h = e),
      (e = f),
      (f = g),
      (g = b),
...
sjcl.bitArray = {
  bitSlice: function(a, b, c) {
    ...
    return c === u ? a : sjcl.bitArray.clamp(a, c - b);
  },
  ...
  concat: function(a, b) {
    ...
    return 32 === d ? a.concat(b) : sjcl.bitArray.Q(b, d, c | 0, a.slice(0, a.length - 1));
  },
  ...
  Q: function(a, b, c, d) {
    var e;
    e = 0;
    for (d === u && (d = []); 32 <= b; b -= 32) d.push(c), (c = 0);
...
sjcl.hash.sha256 = function(a) {
  this.b[0] || this.t();
  a ? ((this.e = a.e.slice(0)), (this.c = a.c.slice(0)), (this.a = a.a)) : this.reset();
};
...
sjcl.hash.sha256.prototype = {
  ...
  update: function(a) {
    ...
    var b,
      c = (this.c = sjcl.bitArray.concat(this.c, a));
    b = this.a;
    a = this.a = b + sjcl.bitArray.bitLength(a);
    for (b = (512 + b) & -512; b <= a; b += 512) this.g(c.splice(0, 16));
    return this;
  },
  finalize: function() {
    var a,
    ...
    for (b.push(this.a | 0); b.length; ) this.g(b.splice(0, 16));
    this.reset();
    return c;
  },
  h: [],
...
sjcl.hash.sha512.prototype = {
  ...
  update: function(a) {
    ...
    b = this.a;
    a = this.a = b + sjcl.bitArray.bitLength(a);
    for (b = (1024 + b) & -1024; b <= a; b += 1024) this.g(c.splice(0, 32));
    return this;
  },
  finalize: function() {
    var a,
    ...
    for (b.push(this.a | 0); b.length; ) this.g(b.splice(0, 32));
    this.reset();
    return c;
  },
  h: [],
  aa: [12372232, 13281083, 9762859, 1914609, 15106769, 4090911, 4308331, 8266105],
  b: [],
  ca: [
    2666018,
    15689165,
  ...
  t: function() {
    ...
    var c = 0,
      ...
      e;
    a: for (; 80 > c; d++) {
      for (e = 2; e * e <= d; e++) if (0 === d % e) continue a;
      8 > c && ((this.h[2 * c] = a(Math.pow(d, 0.5))), (this.h[2 * c + 1] = (b(Math.pow(d, 0.5)) << 24) | this.aa[c]));
      this.b[2 * c] = a(Math.pow(d, 1 / 3));
      this.b[2 * c + 1] = (b(Math.pow(d, 1 / 3)) << 24) | this.ca[c];
      c++;
    }
  },
  g: function(a) {
    ...
    for (a = 0; 80 > a; a++) {
      if (16 > a) (b = d[2 * a]), (c = d[2 * a + 1]);
        ...
        c = d[2 * (a - 15)];
        var r = d[2 * (a - 15) + 1];
        b = ((r << 31) | (c >>> 1)) ^ ((r << 24) | (c >>> 8)) ^ (c >>> 7);
        var A = ((c << 31) | (r >>> 1)) ^ ((c << 24) | (r >>> 8)) ^ ((c << 25) | (r >>> 7));
        c = d[2 * (a - 2)];
        var B = d[2 * (a - 2) + 1],
          r = ((B << 13) | (c >>> 19)) ^ ((c << 3) | (B >>> 29)) ^ (c >>> 6),
          B = ((c << 13) | (B >>> 19)) ^ ((B << 3) | (c >>> 29)) ^ ((c << 26) | (B >>> 6)),
          Y = d[2 * (a - 7)],
          Z = d[2 * (a - 16)],
          N = d[2 * (a - 16) + 1];
        c = A + d[2 * (a - 7) + 1];
      ...
      var Y = (z & Q) ^ (~z & R),
        ...
        B = (y & H) ^ (y & I) ^ (H & I),
        ia = (w & F) ^ (w & G) ^ (F & G),
        Z = ((w << 4) | (y >>> 28)) ^ ((y << 30) | (w >>> 2)) ^ ((y << 25) | (w >>> 7)),
        N = ((y << 4) | (w >>> 28)) ^ ((w << 30) | (y >>> 2)) ^ ((w << 25) | (y >>> 7)),
        ja = f[2 * a],
        fa = f[2 * a + 1],
        r = M + (((z << 18) | (x >>> 14)) ^ ((z << 14) | (x >>> 18)) ^ ((x << 23) | (z >>> 9))),
        A =
          X +
          (((x << 18) | (z >>> 14)) ^ ((x << 14) | (z >>> 18)) ^ ((z << 23) | (x >>> 9))) +
          (r >>> 0 < M >>> 0 ? 1 : 0),
        r = r + ea,
        A = A + (Y + (r >>> 0 < ea >>> 0 ? 1 : 0)),
        r = r + fa,
    ...
    l = e[3] = (l + F) | 0;
    e[2] = (k + H + (l >>> 0 < F >>> 0 ? 1 : 0)) | 0;
    m = e[5] = (m + G) | 0;
    e[4] = (n + I + (m >>> 0 < G >>> 0 ? 1 : 0)) | 0;
    s = e[7] = (s + J) | 0;
    e[6] = (p + W + (s >>> 0 < J >>> 0 ? 1 : 0)) | 0;
    C = e[9] = (C + x) | 0;
    e[8] = (t + z + (C >>> 0 < x >>> 0 ? 1 : 0)) | 0;
    D = e[11] = (D + K) | 0;
    e[10] = (E + Q + (D >>> 0 < K >>> 0 ? 1 : 0)) | 0;
    O = e[13] = (O + L) | 0;
    e[12] = (ca + R + (O >>> 0 < L >>> 0 ? 1 : 0)) | 0;
    P = e[15] = (P + M) | 0;
    e[14] = (da + X + (P >>> 0 < M >>> 0 ? 1 : 0)) | 0;
  },
};
...
sjcl.hash.sha1.prototype = {
  ...
  update: function(a) {
    ...
    b = this.a;
    a = this.a = b + sjcl.bitArray.bitLength(a);
    for (b = (this.blockSize + b) & -this.blockSize; b <= a; b += this.blockSize) this.g(c.splice(0, 16));
    return this;
  },
  finalize: function() {
    var a,
      ...
      16 <= a &&
        ...
        (b =
          19 >= a
            ...
            ? d ^ e ^ f
            : u),
        (b = (((c << 5) | (c >>> 27)) + b + g + h[a] + this.b[Math.floor(a / 20)]) | 0),
        (g = f),
        (f = e),
        (e = (d << 30) | (d >>> 2)),
        (d = c),
...
sjcl.mode.ccm = {
  ...
  encrypt: function(a, b, c, d, e) {
    ...
    f < 15 - k && (f = 15 - k);
    c = h.clamp(c, 8 * (15 - f));
    b = sjcl.mode.ccm.N(a, b, c, d, e, f);
    g = sjcl.mode.ccm.s(a, g, c, b, e, f);
  ...
  decrypt: function(a, b, c, d, e) {
    ...
    b < 15 - g && (b = 15 - g);
    c = f.clamp(c, 8 * (15 - b));
    k = sjcl.mode.ccm.s(a, k, c, l, e, b);
    a = sjcl.mode.ccm.N(a, k.data, c, d, e, b);
...
sjcl.mode.ocb2 = {
  ...
  decrypt: function(a, b, c, d, e, f) {
    ...
    for (c = 0; c + 4 < s / 32; c += 4)
      (m = k(n, a.decrypt(k(n, b.slice(c, c + 4))))), (l = k(l, m)), (t = t.concat(m)), (n = g(n));
    p = s - 32 * c;
...
sjcl.mode.gcm = {
  ...
  s: function(a, b, c, d, e, f) {
    ...
    g = b.encrypt([0, 0, 0, 0]);
    96 === h
      ? ((e = e.slice(0)), (e = t.concat(e, [1])))
      : ((e = sjcl.mode.gcm.l(g, [0, 0, 0, 0], e)),
        (e = sjcl.mode.gcm.l(g, e, [0, 0, Math.floor(h / 0x100000000), h & 0xffffffff])));
    h = sjcl.mode.gcm.l(g, [0, 0, 0, 0], d);
    n = e.slice(0);
    d = h.slice(0);
    a || (d = sjcl.mode.gcm.l(g, h, c));
    for (l = 0; l < m; l += 4)
    ...
    d = sjcl.mode.gcm.l(g, d, a);
    k = b.encrypt(e);
    d[0] ^= k[0];
    d[1] ^= k[1];
    d[2] ^= k[2];
    d[3] ^= k[3];
    return { tag: t.bitSlice(d, 0, f), data: c };
  },
};
sjcl.misc.hmac = function(a, b) {
  this.O = b = b || sjcl.hash.sha256;
  var c = [[], []],
    d,
  ...
  this.r[0].update(c[0]);
  this.r[1].update(c[1]);
  this.I = new b(this.r[0]);
};
sjcl.misc.hmac.prototype.encrypt = sjcl.misc.hmac.prototype.mac = function(a) {
  this.R && q(new sjcl.exception.invalid('encrypt on already updated hmac called!'));
  this.update(a);
  return this.digest(a);
};
sjcl.misc.hmac.prototype.reset = function() {
  this.I = new this.O(this.r[0]);
  this.R = v;
};
...
sjcl.misc.hmac.prototype.digest = function() {
  var a = this.I.finalize(),
    a = new this.O(this.r[1]).update(a).finalize();
  this.reset();
  return a;
};
...
sjcl.prng = function(a) {
  ...
  this.G = 0;
  this.M = {};
  this.P = this.i = this.n = this.X = 0;
  this.b = [0, 0, 0, 0, 0, 0, 0, 0];
  this.k = [0, 0, 0, 0];
  this.D = u;
  this.F = a;
  this.u = v;
  this.C = { progress: {}, seeded: {} };
  this.q = this.W = 0;
  this.A = 1;
  this.B = 2;
  this.T = 0x10000;
  this.K = [0, 48, 64, 96, 128, 192, 0x100, 384, 512, 768, 1024];
  this.U = 3e4;
  this.S = 80;
};
sjcl.prng.prototype = {
  randomWords: function(a, b) {
    ...
    d = this.isReady(b);
    var e;
    d === this.q && q(new sjcl.exception.notReady("generator isn't seeded"));
    if (d & this.B) {
      d = !(d & this.A);
      e = [];
      var f = 0,
      ...
      for (
        g = 0;
        g < this.f.length &&
        !((e = e.concat(this.f[g].finalize())), (f += this.m[g]), (this.m[g] = 0), !d && this.H & (1 << g));
        g++
      );
      this.H >= 1 << this.f.length && (this.f.push(new sjcl.hash.sha256()), this.m.push(0));
      this.i -= f;
      f > this.n && (this.n = f);
      this.H++;
      this.b = sjcl.hash.sha256.hash(this.b.concat(e));
      this.D = new sjcl.cipher.aes(this.b);
      for (d = 0; 4 > d && !((this.k[d] = (this.k[d] + 1) | 0), this.k[d]); d++);
    }
    for (d = 0; d < a; d += 4) 0 === (d + 1) % this.T && ba(this), (e = S(this)), c.push(e[0], e[1], e[2], e[3]);
    ba(this);
    return c.slice(0, a);
  },
  ...
  addEntropy: function(a, b, c) {
    ...
    var d,
      ...
      k = 0;
    d = this.M[c];
    d === u && (d = this.M[c] = this.X++);
    g === u && (g = this.w[c] = 0);
    this.w[c] = (this.w[c] + 1) % this.f.length;
    switch (typeof a) {
      case 'number':
        b === u && (b = 1);
        this.f[g].update([d, this.G++, 1, b, f, 1, a | 0]);
        break;
      case 'object':
        ...
        if (!k) {
          if (b === u) for (c = b = 0; c < a.length; c++) for (e = a[c]; 0 < e; ) b++, (e >>>= 1);
          this.f[g].update([d, this.G++, 2, b, f, a.length].concat(a));
        }
        break;
      case 'string':
        b === u && (b = a.length);
        this.f[g].update([d, this.G++, 3, b, f, a.length]);
        this.f[g].update(a);
        break;
      default:
        k = 1;
    ...
    this.i += b;
    h === this.q &&
      (this.isReady() !== this.q && ga('seeded', Math.max(this.n, this.i)), ga('progress', this.getProgress()));
  },
  isReady: function(a) {
    a = this.K[a !== u ? a : this.F];
    return this.n && this.n >= a
      ? this.m[0] > this.S && new Date().valueOf() > this.P
        ? this.B | this.A
        : this.A
      : this.i >= a
      ? this.B | this.q
  ...
  getProgress: function(a) {
    a = this.K[a ? a : this.F];
    return this.n >= a ? 1 : this.i > a ? 1 : this.i / a;
  },
  startCollectors: function() {
    this.u ||
      ((this.d = {
        loadTimeCollector: T(this, this.da),
        mouseCollector: T(this, this.ea),
        keyboardCollector: T(this, this.ba),
        accelerometerCollector: T(this, this.V),
      }),
      window.addEventListener
        ? (window.addEventListener('load', this.d.loadTimeCollector, v),
          window.addEventListener('mousemove', this.d.mouseCollector, v),
          window.addEventListener('keypress', this.d.keyboardCollector, v),
          window.addEventListener('devicemotion', this.d.accelerometerCollector, v))
        : document.attachEvent
        ? (document.attachEvent('onload', this.d.loadTimeCollector),
          document.attachEvent('onmousemove', this.d.mouseCollector),
          document.attachEvent('keypress', this.d.keyboardCollector))
  ...
  stopCollectors: function() {
    this.u &&
      (window.removeEventListener
        ? (window.removeEventListener('load', this.d.loadTimeCollector, v),
          window.removeEventListener('mousemove', this.d.mouseCollector, v),
          window.removeEventListener('keypress', this.d.keyboardCollector, v),
          window.removeEventListener('devicemotion', this.d.accelerometerCollector, v))
        : document.detachEvent &&
          (document.detachEvent('onload', this.d.loadTimeCollector),
          document.detachEvent('onmousemove', this.d.mouseCollector),
          document.detachEvent('keypress', this.d.keyboardCollector)),
      (this.u = v));
  },
...
function U(a) {
  window && window.performance && 'function' === typeof window.performance.now
    ? sjcl.random.addEntropy(window.performance.now(), a, 'loadtime')
    : sjcl.random.addEntropy(new Date().valueOf(), a, 'loadtime');
}
function ba(a) {
  a.b = S(a).concat(S(a));
  a.D = new sjcl.cipher.aes(a.b);
}
function S(a) {
  for (var b = 0; 4 > b && !((a.k[b] = (a.k[b] + 1) | 0), a.k[b]); b++);
  return a.D.encrypt(a.k);
}
function T(a, b) {
  return function() {
    b.apply(a, arguments);
...
a: try {
  var V, ha, $;
  if ('undefined' !== typeof module && module.exports && (ha = require('crypto')) && ha.randomBytes)
    (V = ha.randomBytes(128)),
      (V = new Uint32Array(new Uint8Array(V).buffer)),
      sjcl.random.addEntropy(V, 1024, "crypto['randomBytes']");
  else if (window && Uint32Array) {
    $ = new Uint32Array(32);
    if (window.crypto && window.crypto.getRandomValues) window.crypto.getRandomValues($);
    else if (window.msCrypto && window.msCrypto.getRandomValues) window.msCrypto.getRandomValues($);
    else break a;
    sjcl.random.addEntropy($, 1024, "crypto['getRandomValues']");
  }
} catch (ka) {
  console.log('There was an error collecting entropy from the browser:'), console.log(ka);
}
sjcl.json = {
  ...
  decode: function(a) {
    ...
    for (c = 0; c < a.length; c++)
      (d = a[c].match(/^(?:(["']?)([a-z][a-z0-9]*)\1):(?:(\d+)|"([a-z0-9+\/%*_.@=\-]*)")$/i)) ||
  ...
  j: function(a, b, c) {
    ...
    for (var d in b)
      b.hasOwnProperty(d) &&
        (c && (a[d] !== u && a[d] !== b[d]) && q(new sjcl.exception.invalid('required parameter overridden')),
        (a[d] = b[d]));
    return a;
  },
  ha: function(a, b) {
  ...
  ga: function(a, b) {
    var c = {},
      d;
    for (d = 0; d < b.length; d++) a[b[d]] !== u && (c[b[d]] = a[b[d]]);
    return c;
  },
};
