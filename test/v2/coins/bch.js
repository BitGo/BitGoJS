...
describe('BCH:', function() {
  ...
  describe('canonical addresses', function() {
    ...
    it('should reject invalid addresses', function() {
      ...
      assert.throws(function () { bch.canonicalAddress('bitcoincash:sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e', 'base58'); });

      // mismatched data segment (bech32)
      assert.throws(function () { bch.canonicalAddress('bitcoincash:yr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e', 'base58'); });

      // double prefix
      assert.throws(function () { bch.canonicalAddress('bitcoincash:bitcoincash:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e', 'base58'); });

      // mismatched data segment (base58)
      assert.throws(function () { bch.canonicalAddress('3DDsS579y7sruadqu11beEJoTjdFiFCdX4', 'base58'); });

      // improper prefix
      assert.throws(function () { bch.canonicalAddress(':qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'base58'); });
      ...
      // undefined address
      assert.throws(function () { bch.canonicalAddress(undefined, 'blah'); });
    });
  });
