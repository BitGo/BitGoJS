...
import * as mockData from '../fixtures/bera';
...
describe('Bera', function () {
  ...
  describe('Basic Coin Info', function () {
    it('should return the right info for arbeth', function () {
      ...
      arbeth.should.be.an.instanceof(Bera);
    ...
    it('should return the right info for tbera', function () {
      ...
      tbera.getFullName().should.equal('Testnet Arbitrum Ethereum (L2 Chain)');
  ...
  describe('Recover transaction:', function () {
    ...
    it('should generate an unsigned sweep', async function () {
      ...
      const basecoin = bitgo.coin('tbera') as Bera;
