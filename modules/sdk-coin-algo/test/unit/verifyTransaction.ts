...
describe('Algorand Verify Transaction:', function () {
  ...
  describe('Key Registration Transaction Validation', () => {
    it('should validate valid key registration transaction', async function () {
      const txParams = {
        // Key registration specific params would go here
      };
      const txPrebuild = {
        txHex: testData.rawTx.keyReg.unsigned,
      };
