...
// Type-only imports of the canonical V1-family statics. These are erased at
// compile time (verbatimModuleSyntax), so this module adds NO runtime edge
// from the family chunk to the v1_0 generated-types chunk — each version's
// chunk still loads only its own generated module.
import type {
  Nonce,
  OrderRedeemerV1,
  RegistryV1,
  SettingsV1 as SettingsV1_0,
 ...
 */
export type TV1SettingsConfig = Pick<
  SettingsV1_0,
  "reserve_assets" | "unstaked_yield_pot"
>;
