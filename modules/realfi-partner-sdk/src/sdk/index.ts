 ...
 */
export type TRealfiSDKParams =
  | IRealfiSDKParamsV0
  | IRealfiSDKParamsV0_1
  | IRealfiSDKParamsV0_2
  | IRealfiSDKParamsV0_3
 ...
 */
export type TRealfiSDK<P extends Provider, W extends Wallet> =
  | RealfiSDKV0<P, W>
  | RealfiSDKV0_1<P, W>
  | RealfiSDKV0_2<P, W>
  | RealfiSDKV0_3<P, W>
...
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: IRealfiSDKParamsV0,
): Promise<RealfiSDKV0<P, W>>;
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: IRealfiSDKParamsV0_1,
): Promise<RealfiSDKV0_1<P, W>>;
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: IRealfiSDKParamsV0_2,
): Promise<RealfiSDKV0_2<P, W>>;
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: IRealfiSDKParamsV0_3,
): Promise<RealfiSDKV0_3<P, W>>;
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: IRealfiSDKParamsV0_4,
): Promise<RealfiSDKV0_4<P, W>>;
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: IRealfiSDKParamsV1_0,
): Promise<RealfiSDKV1_0<P, W>>;
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: IRealfiSDKParamsV1_0Rc1,
): Promise<RealfiSDKV1_0Rc1<P, W>>;
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: IRealfiSDKParamsV1_1Rc1,
): Promise<RealfiSDKV1_1Rc1<P, W>>;
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
...
function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: TRealfiSDKParams,
): Promise<TRealfiSDK<P, W>>;
async function createRealfiSDK<P extends Provider, W extends Wallet>(
  blaze: Blaze<P, W>,
  params: TRealfiSDKParams,
): Promise<TRealfiSDK<P, W>> {
  switch (params.version) {
    case "V0": {
      const { RealfiSDKV0 } = await import("./v0/index.js");
      return RealfiSDKV0.create(blaze, params);
    }
    case "V0_1": {
      const { RealfiSDKV0_1 } = await import("./v0_1/index.js");
      return RealfiSDKV0_1.create(blaze, params);
    }
    case "V0_2": {
      const { RealfiSDKV0_2 } = await import("./v0_2/index.js");
      return RealfiSDKV0_2.create(blaze, params);
    }
    case "V0_3": {
      const { RealfiSDKV0_3 } = await import("./v0_3/index.js");
      return RealfiSDKV0_3.create(blaze, params);
    }
    case "V0_4": {
      const { RealfiSDKV0_4 } = await import("./v0_4/index.js");
      return RealfiSDKV0_4.create(blaze, params);
    }
    case "V1_0": {
      const { RealfiSDKV1_0 } = await import("./v1_0/index.js");
      return RealfiSDKV1_0.create(blaze, params);
    }
    case "V1_0_Rc1": {
      const { RealfiSDKV1_0Rc1 } = await import("./v1_0_rc1/index.js");
      return RealfiSDKV1_0Rc1.create(blaze, params);
    }
    case "V1_1_Rc1": {
      const { RealfiSDKV1_1Rc1 } = await import("./v1_1_rc1/index.js");
      return RealfiSDKV1_1Rc1.create(blaze, params);
    }
    default:
      throw new Error(
        `Unknown SDK version: ${(params as TRealfiSDKParams).version}`,
      );
  }
}
...
export const RealfiSDK = {
  ...
  detectParams: (async (
    ...
    const { detectSDKParams } = await import("./shared/detect-params.js");
    ...
    return typeof config === "string"
      ? detectSDKParams(provider, config)
      : detectSDKParams(provider, config);
  }) as IDetectParams,
};
