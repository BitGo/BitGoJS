...
export type { IBuildStakeContinuationParams, IStakeContinuation, IStakeContinuationSwap, } from "./v1/family.js";
type TCardanoVersionProp = "version";
type TCardanoReadMethods = "getRawProxyDatum" | "getParsedProxyDatum" | "getSettings" | "getTreasuryDatum" | "getVaultDatum" | "getUsdrAssetId" | "getSusdrAssetId";
type TCardanoOrderMethods = "buildMintOrderTx" | "buildRedeemOrderTx" | "buildStakeOrderTx" | "buildUnstakeOrderTx" | "buildDepositOrderTx" | "buildWithdrawOrderTx" | "buildCancelOrdersTx" | "buildClaimTimelockTx";
type TCardanoOrderMethodsV1 = "buildInvalidatedOrdersTx" | "buildStakeContinuation";
/** Partner-facing surface of the V0_4 SDK: order builders + read helpers only. */
export interface IRealfiCardanoSDKV0_4<P extends Provider, W extends Wallet> extends Pick<RealfiSDKV0_4<P, W>, TCardanoVersionProp | TCardanoReadMethods | TCardanoOrderMethods> {
}
/** Partner-facing surface of the V1_0 SDK. */
export interface IRealfiCardanoSDKV1_0<P extends Provider, W extends Wallet> extends Pick<RealfiSDKV1_0<P, W>, TCardanoVersionProp | TCardanoReadMethods | TCardanoOrderMethods | TCardanoOrderMethodsV1> {
}
/** Partner-facing surface of the V1_0_Rc1 SDK. */
export interface IRealfiCardanoSDKV1_0Rc1<P extends Provider, W extends Wallet> extends Pick<RealfiSDKV1_0Rc1<P, W>, TCardanoVersionProp | TCardanoReadMethods | TCardanoOrderMethods | TCardanoOrderMethodsV1> {
}
/** Partner-facing surface of the V1_1_Rc1 SDK. */
export interface IRealfiCardanoSDKV1_1Rc1<P extends Provider, W extends Wallet> extends Pick<RealfiSDKV1_1Rc1<P, W>, TCardanoVersionProp | TCardanoReadMethods | TCardanoOrderMethods | TCardanoOrderMethodsV1> {
}
/** Any partner-facing SDK the facade can return after version detection. */
export type TRealfiCardanoSDK<P extends Provider, W extends Wallet> = IRealfiCardanoSDKV0_4<P, W> | IRealfiCardanoSDKV1_0<P, W> | IRealfiCardanoSDKV1_0Rc1<P, W> | IRealfiCardanoSDKV1_1Rc1<P, W>;
...
export interface IRealfiCardanoCreateOptions {
     ...
     */
    onVersionChange?: (previous: TDetectedVersion, next: TDetectedVersion) => void;
}
/**
...
export interface IRealfiCardanoFactory {
    create<P extends Provider, W extends Wallet>(blaze: Blaze<P, W>, params: IRealfiSDKParamsV0_4, options?: IRealfiCardanoCreateOptions): Promise<IRealfiCardanoSDKV0_4<P, W>>;
    create<P extends Provider, W extends Wallet>(blaze: Blaze<P, W>, params: IRealfiSDKParamsV1_0, options?: IRealfiCardanoCreateOptions): Promise<IRealfiCardanoSDKV1_0<P, W>>;
    create<P extends Provider, W extends Wallet>(blaze: Blaze<P, W>, params: IRealfiSDKParamsV1_0Rc1, options?: IRealfiCardanoCreateOptions): Promise<IRealfiCardanoSDKV1_0Rc1<P, W>>;
    create<P extends Provider, W extends Wallet>(blaze: Blaze<P, W>, params: IRealfiSDKParamsV1_1Rc1, options?: IRealfiCardanoCreateOptions): Promise<IRealfiCardanoSDKV1_1Rc1<P, W>>;
    create<P extends Provider, W extends Wallet>(blaze: Blaze<P, W>, params: TDetectedSDKParams, options?: IRealfiCardanoCreateOptions): Promise<TRealfiCardanoSDK<P, W>>;
    detectParams(provider: Provider, config: IDetectInput): Promise<TDetectedSDKParams>;
    detectParams(provider: Provider, network: TNetworkPreset): Promise<TDetectedSDKParams>;
}
