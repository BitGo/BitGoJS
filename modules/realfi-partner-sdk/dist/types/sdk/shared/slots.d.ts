 ...
 */
export declare function slotFloor(clock: TSlotClock, timeMs: bigint | number): Core.Slot;
/**
 ...
 */
export declare function slotAlignedTimeMs(clock: TSlotClock, timeMs: bigint | number): bigint;
