...
import type { GovernanceConfig, MultisigScript, Permissions, ProtocolConfig, RegistryV1, SettingsV1, Tuple_VerificationKey_COSESign1 } from "../../generated-types/v1_1_rc1/index.js";
/**
...
export interface IProtocolSettingsAdminSource<P extends Provider, W extends Wallet> {
...
export interface IResolvedSettingsChange {
    redeemer: "ChangeLogic" | "ChangePermissions" | "ChangeConfig" | "Shutdown" | "Restore" | "Migrate";
    nextLogicHash: Core.ScriptHash;
...
export interface IProtocolSettingsAdminInstance<P extends Provider, W extends Wallet> {
    readonly blaze: Blaze<P, W>;
...
export type TGovernancePermissionKey = "logic_change" | "permission_change" | "config_change" | "shutdown" | "restore" | "migrate";
