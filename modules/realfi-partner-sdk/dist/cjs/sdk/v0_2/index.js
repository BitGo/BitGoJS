 ...
 */
var RealfiSDKV0_2 = exports.RealfiSDKV0_2 = /*#__PURE__*/function (_RealfiSDKBase) {
  function RealfiSDKV0_2(blaze, params, scripts, cachedReferenceInputs) {
    var _this;
    _classCallCheck(this, RealfiSDKV0_2);
    _this = _callSuper(this, RealfiSDKV0_2, [blaze, params, cachedReferenceInputs]);
    _defineProperty(_this, "version", "V0_2");
   ...
   */
  _inherits(RealfiSDKV0_2, _RealfiSDKBase);
  return _createClass(RealfiSDKV0_2, [{
    key: "mintTreasuryNFT",
    value: // ─────────────────────────────────────────────────────────────────────────────
    // Treasury Operations
    // ─────────────────────────────────────────────────────────────────────────────
      ...
      var _mintOneShot = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(receiverAddress, datum) {
        ...
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.n) {
            ...
            case 1:
              utxo = _context4.v;
              serializedDatum = Data.serialize(_index.V0_2Types.ProxyDatum, {
                logic: datum.logic,
        ...
        return _regenerator().w(function (_context5) {
          while (1) switch (_context5.n) {
            ...
            case 2:
              ...
              return _context5.a(2, (0, _index3.lockOrPayAssets)(this.blaze.newTransaction().addInput(oneshotUtxo), receiverAddress, (0, _sdk.makeValue)(10000000n, [this.oneShotPolicyId, 1n]), serializedDatum));
          }
        }, _callee5, this);
      }));
        ...
        return _regenerator().w(function (_context6) {
          while (1) switch (_context6.n) {
            ...
            case 2:
              ...
              parsedProxyDatum = (0, _data.parse)(_index.V0_2Types.ProxyDatum, proxyDatum);
              result = {
                proxyUtxo: proxyUtxo,
    ...
    value: function () {
      var _buildMintTx = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(assetAmount) {
        var isBurn, rewardAccount, conversionRatio, _yield$this$getParsed, proxyUtxo, parsedProxyDatum, treasuryScriptHash, refInputs, _yield$getDatumFromNF2, treasuryUtxo, parsedTreasuryDatum, circulatingSupply, newCirculatingSupply, newTreasuryDatum, reserveToken, reserveTokenAmount, treasuryAddress, redeemer, assetName, initialTreasuryValue, valueToAdd, updatedTreasuryValue, tx, requiredSigners, _iterator, _step, signer, receiverAddress, _requiredSigners, _iterator2, _step2, _signer;
        return _regenerator().w(function (_context7) {
          while (1) switch (_context7.n) {
            case 0:
              isBurn = assetAmount.amount < 0n;
              rewardAccount = this.getProtocolRewardAccount();
              conversionRatio = 1; // V0_2 uses 1:1 conversion ratio (no decimals taken into account, etc.)
              _context7.n = 1;
            ...
            case 2:
              ...
              _context7.n = 3;
              return (0, _index3.getDatumFromNFT)(this.blaze, this.treasuryNFTAssetId, _index.V0_1Types.TreasuryDatum);
            case 3:
              ...
              reserveTokenAmount = BigInt(conversionRatio) * assetAmount.amount;
              treasuryAddress = (0, _core.addressFromCredential)(this.network, (0, _index3.credentialFromScriptHash)(treasuryScriptHash));
              redeemer = isBurn ? Data.serialize(_index.V0_2Types.ProtocolRedeemer, "Burn") : Data.serialize(_index.V0_2Types.ProtocolRedeemer, "Mint");
              assetName = _sdk.Core.AssetName(this.assetNameHex);
              initialTreasuryValue = treasuryUtxo.output().amount();
              valueToAdd = (0, _sdk.makeValue)(0n, [reserveToken, reserveTokenAmount]);
              ...
              requiredSigners = (0, _index3.getSignatureKeyHashesFromMultisigScript)(parsedProxyDatum.settings.burn_permission).map(function (key) {
            ...
            case 4:
              ...
              (0, _index3.addDirectOutput)(tx, receiverAddress, (0, _sdk.makeValue)(0n, [reserveToken, -assetAmount.amount]));
              _context7.n = 6;
              break;
            case 5:
              _requiredSigners = (0, _index3.getSignatureKeyHashesFromMultisigScript)(parsedProxyDatum.settings.mint_permission).map(function (key) {
                return _sdk.Core.Ed25519KeyHashHex(key);
              });
    ...
    key: "buildDepositTx",
    value: function () {
      var _buildDepositTx = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(assetAmount) {
        var _assetAmount$id;
        var refInputs, _yield$this$getParsed2, proxyUtxo, parsedProxyDatum, _yield$this$getTreasu, treasuryUtxo, treasuryDatum, redeemer, rewardAccount, requiredSigners, reserveToken, treasuryAddress, inititalTreasuryValue, depositValue, newTreasuryValue, tx, _iterator3, _step3, signer;
        return _regenerator().w(function (_context8) {
          while (1) switch (_context8.n) {
            ...
            case 1:
              refInputs = _context8.v;
              _context8.n = 2;
              return this.getParsedProxyDatum();
            case 2:
              _yield$this$getParsed2 = _context8.v;
            ...
            case 3:
              ...
              treasuryDatum = _yield$this$getTreasu.treasuryDatum;
              redeemer = Data.serialize(_index.V0_2Types.ProtocolRedeemer, {
                Deposit: {
              ...
              tx = this.blaze.newTransaction().addWithdrawal(rewardAccount, 0n, redeemer).addReferenceInput(proxyUtxo).addReferenceInput(refInputs.protocol).addReferenceInput(refInputs.proxy).addReferenceInput(refInputs.treasury).addInput(treasuryUtxo, Data.Void()).lockAssets(treasuryAddress, newTreasuryValue, treasuryDatum);
              _iterator3 = _createForOfIteratorHelper(requiredSigners);
              try {
              ...
              return _context8.a(2, tx);
          }
        }, _callee8, this);
      }));
      function buildDepositTx(_x7) {
    ...
    key: "buildWithdrawTx",
    value: (function () {
      var _buildWithdrawTx = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(assetAmount, receiverAddress) {
        var _assetAmount$id2;
        var refInputs, receiver, _yield$this$getParsed3, proxyUtxo, parsedProxyDatum, _yield$this$getTreasu2, treasuryUtxo, treasuryDatum, redeemer, rewardAccount, requiredSigners, reserveToken, treasuryAddress, inititalTreasuryValue, withdrawValue, newTreasuryValue, tx, _iterator4, _step4, signer, _t;
        return _regenerator().w(function (_context9) {
          while (1) switch (_context9.n) {
            ...
            case 1:
              ...
              _t = _sdk.Core.Address.fromBech32(receiverAddress);
              _context9.n = 4;
              break;
            case 2:
              _context9.n = 3;
            ...
            case 6:
              ...
              tx = this.blaze.newTransaction().addWithdrawal(rewardAccount, 0n, redeemer).addReferenceInput(proxyUtxo).addReferenceInput(refInputs.protocol).addReferenceInput(refInputs.proxy).addReferenceInput(refInputs.treasury).addInput(treasuryUtxo, Data.Void());
              ...
              _iterator4 = _createForOfIteratorHelper(requiredSigners);
              try {
      ...
      function buildWithdrawTx(_x8, _x9) {
    ...
    value: function create(blaze, params) {
      ...
      var protocolScript = new _index.V0_2Types.V0_2ProtocolProtocolWithdraw(oneShotPolicyId, enableTrace).Script;
