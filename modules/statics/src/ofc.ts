...
import { OfcCoin, OfcConstructorOptions, DISALLOWED_FEATURES, REQUIRED_FEATURES } from './ofcCoin';

export { OfcCoin, OfcConstructorOptions, DISALLOWED_FEATURES, REQUIRED_FEATURES };
