...
export const bscTokens = [
  ...
  bscToken(
    'b6513cd5-aae0-40cf-96e1-4ec9f64b7cd2',
    'bsc:beat',
    'Beat Token',
    18,
    '0xcf3232b85b43bca90e51d38cc06cc8bb8c8a3e36',
    UnderlyingAsset['bsc:beat'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '690a77fa-4b0c-472c-bf12-66cfae612f63',
    'bsc:velvet',
    'Velvet',
    18,
    '0x8b194370825e37b33373e74a41009161808c1488',
    UnderlyingAsset['bsc:velvet'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'a153e64c-3978-421e-9219-606a193bc5c9',
    'bsc:genius',
    'Genius',
    18,
    '0x1f12b85aac097e43aa1555b2881e98a51090e9a6',
    UnderlyingAsset['bsc:genius'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '80b8a66d-c13d-4a6d-9454-088d4ddfc0fe',
    'bsc:tag',
    'Tagger',
    18,
    '0x208bf3e7da9639f1eaefa2de78c23396b0682025',
    UnderlyingAsset['bsc:tag'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '586ed5a5-4eeb-4145-aaf4-02c54979046d',
    'bsc:ab',
    'AB',
    18,
    '0x95034f653d5d161890836ad2b6b8cc49d14e029a',
    UnderlyingAsset['bsc:ab'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '2f9c3d30-78b1-4b1f-b7e6-2fc8c0f20d2e',
    'bsc:cheems',
    'Cheems (cheems.pet)',
    18,
  ...
  bscToken(
    '0c13bd65-53a4-481a-adc9-a46717095618',
    'bsc:bank',
    'Lorenzo Protocol',
    18,
  ...
  bscToken(
    '5a1971ea-8087-4abf-8204-80760c2c99a5',
    'bsc:wfi',
    'WeFi',
    18,
    '0x90c48855bb69f9d2c261efd0d8c7f35990f2dd6f',
    UnderlyingAsset['bsc:wfi'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '858aaa08-bf74-4f45-8ba9-87047e2828cd',
    'bsc:uai',
    'UnifAI',
    18,
    '0x3e5d4f8aee0d9b3082d5f6da5d6e225d17ba9ea0',
    UnderlyingAsset['bsc:uai'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '08af2b32-0f2d-46d3-ae62-b7fc797670bf',
    'bsc:nila',
    'MindWave',
    18,
    '0x00f8da33734feb9b946fec2228c25072d2e2e41f',
    UnderlyingAsset['bsc:nila'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '4301b202-9351-456d-b61e-45a7e8650eb8',
    'bsc:xpin',
    'XPIN Token',
    18,
    '0xd955c9ba56fb1ab30e34766e252a97ccce3d31a6',
    UnderlyingAsset['bsc:xpin'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '14ea9d5a-8eee-4f97-9845-db804466eb6f',
    'bsc:gps',
    'GoPlus Security',
    18,
    '0x9a4a67721573f2c9209dfff972c52be4e3f6642e',
    UnderlyingAsset['bsc:gps'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'cd7d25fb-b1db-41b3-a169-2634a9d25372',
    'bsc:lab',
    'LAB',
    18,
    '0x7ec43cf65f1663f820427c62a5780b8f2e25593a',
    UnderlyingAsset['bsc:lab'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '0e99fcbb-2c99-49b7-9520-72bf4f35f701',
    'bsc:bdca',
    'BitDCA',
    18,
    '0x0c8382719ef242cae2247e4decb2891fbf699818',
    UnderlyingAsset['bsc:bdca'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'bd5629c2-aba6-4cd5-940a-b4b0a9e1bf76',
    'bsc:glidr',
    'Glidr',
    18,
    '0xc2b1ddb75046c4915c641cc0dc0d0f160ef82be5',
    UnderlyingAsset['bsc:glidr'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '005c50e8-1fca-4de3-bcd4-34a38fd14069',
    'bsc:cross',
    'Cross',
    18,
    '0x6bf62ca91e397b5a7d1d6bce97d9092065d7a510',
    UnderlyingAsset['bsc:cross'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '1f0f0058-0beb-4d6d-8e28-2c8a9ace0734',
    'bsc:pm',
    'PumpMeme',
    18,
    '0x652fcafea5a2da18e8947748b7849b72148b4543',
    UnderlyingAsset['bsc:pm'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '74b7fa62-460b-4369-ba5c-5b8aa2aac9f8',
    'bsc:bsb',
    'Block Street',
    18,
    '0x595deaad1eb5476ff1e649fdb7efc36f1e4679cc',
    UnderlyingAsset['bsc:bsb'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'd238c9b8-be8b-4103-b430-344223739449',
    'bsc:lusd',
    'Liquity USD',
    18,
    '0x5bb4d589467c25a5ac8db930372dc5da30c3410e',
    UnderlyingAsset['bsc:lusd'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '8124d205-aff2-4fe0-bc5b-253c5588b7e5',
    'bsc:wkc',
    'Wiki Cat',
    18,
    '0x6ec90334d89dbdc89e08a133271be3d104128edb',
    UnderlyingAsset['bsc:wkc'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '12ee0848-b554-4b67-bae9-891f8d039b23',
    'bsc:aio',
    'OLAXBT',
    18,
    '0x81a7da4074b8e0ed51bea40f9dcbdf4d9d4832b4',
    UnderlyingAsset['bsc:aio'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '8124f298-2e08-4e27-8f78-e955359a63d5',
    'bsc:collect',
    'Collect on Fanable',
    18,
    '0x4b3d30992f003c8167699735f5ab2831b2a087d3',
    UnderlyingAsset['bsc:collect'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'ef2269db-2ec2-4e8f-baae-1a4951adfc35',
    'bsc:ain',
    'Infinity Ground',
    18,
    '0x9558a9254890b2a8b057a789f413631b9084f4a3',
    UnderlyingAsset['bsc:ain'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'd9c537a2-efb4-44c3-b2a3-1292aa11627c',
    'bsc:b2',
    'BSquared Network',
    18,
    '0x783c3f003f172c6ac5ac700218a357d2d66ee2a2',
    UnderlyingAsset['bsc:b2'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '6e176bbb-8ea5-4fc2-909d-2bbace60c752',
    'bsc:giggle',
    'Giggle Fund',
    18,
  ...
  bscToken(
    '3455bf19-492e-4f28-9e97-c983958bceb9',
    'bsc:aleo',
    'Aleo',
    6,
    '0x6cfffa5bfd4277a04d83307feedfe2d18d944dd2',
    UnderlyingAsset['bsc:aleo'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'd3a31d6f-725d-4556-bcf3-9063764f9333',
    'bsc:lista',
    'Lista DAO',
    18,
    '0xfceb31a79f71ac9cbdcf853519c1b12d379edc46',
    UnderlyingAsset['bsc:lista'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '3ec27aa4-43e8-48fa-8193-b4abbaf6139d',
    'bsc:tpt',
    'Token Pocket',
    4,
    '0xeca41281c24451168a37211f0bc2b8645af45092',
    UnderlyingAsset['bsc:tpt'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'e485bed1-83ae-420a-9611-72ee7c820fbd',
    'bsc:gcb',
    'Global Commercial Business',
    18,
    '0x84f70be4deb029d5f8aacbeacc74c4dc10737342',
    UnderlyingAsset['bsc:gcb'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '5b683223-d810-4435-ab85-7e77b14f9c25',
    'bsc:xny',
    'Codatta',
    18,
    '0xe3225e11cab122f1a126a28997788e5230838ab9',
    UnderlyingAsset['bsc:xny'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'e21afc39-fbbb-4771-b640-e70f12a944ca',
    'bsc:tac',
    'TAC',
    18,
    '0x1219c409fabe2c27bd0d1a565daeed9bd9f271de',
    UnderlyingAsset['bsc:tac'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'fd23611c-7442-4631-a45b-e5fa33ca71b9',
    'bsc:idol',
    'MEET48 Token',
    18,
    '0x3b4de3c7855c03bb9f50ea252cd2c9fa1125ab07',
    UnderlyingAsset['bsc:idol'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'd80a9760-61e8-452b-bebe-2fa41b0ca6ae',
    'bsc:bluai',
    'Bluwhale AI',
    18,
    '0xed9ae3def8d6f052971bb8b6d1975ff267cf9aad',
    UnderlyingAsset['bsc:bluai'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'd37e2e44-ac93-4638-a595-7892d654fca3',
    'bsc:clo',
    'Yei Finance',
    18,
    '0x81d3a238b02827f62b9f390f947d36d4a5bf89d2',
    UnderlyingAsset['bsc:clo'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '368aaaae-4b30-44e6-ace4-63b697d404bb',
    'bsc:hajimi',
    '哈基米',
    18,
    '0x82ec31d69b3c289e541b50e30681fd1acad24444',
    UnderlyingAsset['bsc:hajimi'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '37efe7b8-5a52-4aa9-9d7b-cde727a313d4',
    'bsc:bdx',
    'Beldex',
    9,
    '0x9d10a1ec41fe7878429bb457e31f9b050d38c633',
    UnderlyingAsset['bsc:bdx'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'b47feddc-8d06-4df7-94f4-bf93593c734b',
    'bsc:spcxb',
  ...
  bscToken(
    '9fefe756-fa42-4221-b69d-4010a357936f',
    'bsc:sndkb',
  ...
  bscToken(
    '12c5c302-8274-461f-a695-fda47a2f2bb6',
    'bsc:bananas31',
    'Banana For Scale',
    18,
  ...
  bscToken(
    'a7777927-4e4e-41da-8c07-33df46f238ff',
    'bsc:coai',
    'ChainOpera AI',
    18,
    '0x0a8d6c86e1bce73fe4d0bd531e1a567306836ea5',
    UnderlyingAsset['bsc:coai'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    '18357e8f-d8c7-4281-a845-ce43a3aa28f6',
    'bsc:nes',
    'Nesa',
    18,
    '0x3131f6b80c26936ab03f7d9d29eb4ddf36ac3fb5',
    UnderlyingAsset['bsc:nes'],
    BSC_TOKEN_FEATURES_TRUST_ONLY
  ),
  bscToken(
    'a7413ab2-be0c-401c-ac19-da38046e0ab8',
    'bsc:mgo',
    'Mango Network',
    9,
    '0x5e0d6791edbeeba6a14d1d38e2b8233257118eb1',
