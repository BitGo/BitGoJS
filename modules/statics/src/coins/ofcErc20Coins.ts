...
export const tOfcErc20Coins = [
  ...
  ofcerc20('48ae1eeb-3154-484b-a3a0-d44a599943b3', 'ofceth:nom', 'Nomina (NOM)', 18, underlyingAssetForSymbol('eth:nom')),
  ofcerc20('3818ce74-6854-40d4-8007-ca726b5dfff0', 'ofceth:kite', 'Kite (KITE)', 18, underlyingAssetForSymbol('eth:kite')),
  ofcerc20('81cdf38c-f6d6-4e93-9dda-aae22104834d', 'ofceth:sahara', 'Sahara AI (SAHARA)', 18, underlyingAssetForSymbol('eth:sahara')),
  ofcerc20('0030515b-8a8c-4048-b646-bae43097c51b', 'ofceth:epic', 'Epic Chain (EPIC)', 18, underlyingAssetForSymbol('eth:epic')),
  ofcerc20(
