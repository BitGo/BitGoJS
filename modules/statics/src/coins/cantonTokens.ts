...
export const cantonTokens = [
  ...
  cantonToken(
    ...
    10,
    'https://api.utilities.digitalasset.com/api/token-standard/v0/registrars/',
    '1220b::1220bab043849b986b52bc6271edf1ae962bab03d9f0c0713f071732d2278386bd02:USD1',
  ...
  cantonToken(
    ...
    10,
    'https://api.utilities.digitalasset.com/api/token-standard/v0/registrars/',
    '12206::122064767126065d9d63e87552952f4d488a94c96786b0995c8e4594f205f2734576:SOFID',
    UnderlyingAsset['canton:sofid'],
    [...CANTON_TOKEN_FEATURES, CoinFeature.STABLECOIN]
  ),
  cantonToken(
    '65f1d052-6853-4cd1-a5f9-9a24b483865f',
    'canton:999990690',
    'DTCC Test Token 1',
    10,
  ...
  cantonToken(
    '103cda56-275f-4d8e-b156-611b394c5534',
    'canton:99999x763',
    'DTCC Test Token 2',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
  ...
  cantonToken(
    'faab5664-2764-4988-a234-6231bd1e91df',
    'canton:crcl',
  ...
  cantonToken(
    '9a4256c1-d9f8-428d-9176-cb9a0f34aa25',
    'canton:msft',
    'Microsoft Corp.',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
  ...
  cantonToken(
    'db765dc9-4111-4298-828c-8ed15ce416b4',
    'canton:qqq',
  ...
  cantonToken(
    'b0c429c1-3601-426b-b5bf-f3805b217613',
    'canton:sgov',
  ...
  cantonToken(
    '54c51388-0dd2-4777-b274-812dba5e4042',
    'canton:spy',
  ...
  cantonToken(
    '4c8e8b53-85ec-4bbb-898b-75dc9635e3f9',
    'canton:912797rs8',
    'U.S. Treasury Bill',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
  ...
  cantonToken(
    'ec50d865-2781-4394-8f14-62b6f189a7a7',
    'canton:912797va2',
    'U.S. Treasury Bill',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
  ...
  cantonToken(
    '3d38f809-5e5c-46da-937e-4bbe663cb21b',
    'canton:912797ve4',
    'U.S. Treasury Bill',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
  ...
  cantonToken(
    '613172b4-ed01-4f5e-8803-996a990f6a97',
    'canton:91282cay7',
    'U.S. Treasury Note',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
  ...
  cantonToken(
    '4ac66d54-4224-46a9-b520-b58051d4df20',
    'canton:91282ckf7',
    'U.S. Treasury Note',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
  ...
  cantonToken(
    '33bdba67-a3ff-4b43-a399-f1f63f7fb1bd',
    'canton:91282clw9',
    'U.S. Treasury Note',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
  ...
  cantonToken(
    'ff7f62b3-cf47-4e24-901f-895d7d97f08a',
    'canton:912810rc4',
    'U.S. Treasury Bond',
    10,
    'https://app.cts.dtcc-da.com/api/token-standard/v0/registrars/',
