...
export const ofcCoins = [
  ...
  // CSHLD-623: SUI tokens for Go Accounts support
  ofcSuiToken('f6a7b8c9-d0e1-4f2a-3b4c-5d6e7f8a9b0c', 'ofcsui:afsui', 'afSUI', 9, UnderlyingAsset['sui:afsui']),
  ofcSuiToken('a3b4c5d6-e7f8-4a9b-0c1d-2e3f4a5b6c7d', 'ofcsui:alkimi', 'Alkimi', 9, UnderlyingAsset['sui:alkimi']),
  ofcSuiToken('c9d0e1f2-a3b4-4c5d-6e7f-8a9b0c1d2e3f', 'ofcsui:cetus', 'Cetus', 9, UnderlyingAsset['sui:cetus']),
  ofcSuiToken(
  ...
  ofcSuiToken('e5f6a7b8-c9d0-4e1f-2a3b-4c5d6e7f8a9b', 'ofcsui:fud', 'Fud', 5, UnderlyingAsset['sui:fud']),
  ofcSuiToken('a7b8c9d0-e1f2-4a3b-4c5d-6e7f8a9b0c1d', 'ofcsui:navx', 'navx', 9, UnderlyingAsset['sui:navx']),
  ofcSuiToken('c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', 'ofcsui:sca', 'Scallop', 9, UnderlyingAsset['sui:sca']),
  ofcSuiToken('b8c9d0e1-f2a3-4b4c-5d6e-7f8a9b0c1d2e', 'ofcsui:send', 'Suilend', 6, UnderlyingAsset['sui:send']),
  ofcSuiToken('d4e5f6a7-b8c9-4d0e-1f2a-3b4c5d6e7f8a', 'ofcsui:times', 'Darktimes', 5, UnderlyingAsset['sui:times']),
  ofcSuiToken('a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d', 'ofcsui:usdc', 'USDC', 6, UnderlyingAsset['sui:usdc']),
  ofcSuiToken('e1f2a3b4-c5d6-4e7f-8a9b-0c1d2e3f4a5b', 'ofcsui:wal', 'Walrus', 9, UnderlyingAsset['sui:wal']),
  ofcSuiToken('b2c3d4e5-f6a7-4b8c-9d0e-1f2a3b4c5d6e', 'ofcsui:wusdc', 'Wormhole USDC', 6, UnderlyingAsset['sui:wusdc']),
  ofcSuiToken('f2a3b4c5-d6e7-4f8a-9b0c-1d2e3f4a5b6c', 'ofcsui:xaum', 'Matrixdock Gold', 9, UnderlyingAsset['sui:xaum']),
  ofcSuiToken('d0e1f2a3-b4c5-4d6e-7f8a-9b0c1d2e3f4a', 'ofcsui:xmn', 'xMoney', 6, UnderlyingAsset['sui:xmn']),
  tofcSuiToken('b4c5d6e7-f8a9-4b0c-1d2e-3f4a5b6c7d8e', 'ofctsui:wal', 'Testnet Walrus', 9, UnderlyingAsset['tsui:wal']),
  ...
  tofcAdaToken(
    'a3c1e924-7f5b-4d82-b0e6-3f9d2c8a1b47',
    'ofctada:tusda',
    'Testnet Cardano USDA',
    6,
