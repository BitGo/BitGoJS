 ...
 *
 * Unlike legacy and v0 transactions, where signatures are prefixed before the
 * message, a v1 transaction places the message first and appends the signatures
 * at the tail with no length prefix; the signature count is derived from the
 * message header's numRequiredSignatures.
 *
 ...
 */
export function serializeWireTransaction(messageBytes: Uint8Array, signatures: Uint8Array[]): Uint8Array {
