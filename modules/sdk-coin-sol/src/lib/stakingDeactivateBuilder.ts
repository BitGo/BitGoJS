  ...
  initBuilder(tx: Transaction): void {
    ...
    for (const instruction of this._instructionsData) {
      if (instruction.type === InstructionBuilderTypes.StakingDeactivate) {
        ...
        // // Jito params
        // this.isJito(deactivateInstruction.params.isJito ?? false);
        // if (deactivateInstruction.params.isJito) {
        //   this.recipients(deactivateInstruction.params.recipients ?? []);
        //   if (deactivateInstruction.params.validatorAddress !== undefined) {
        //     this.validatorAddress(deactivateInstruction.params.validatorAddress);
        //   }
        //   if (deactivateInstruction.params.stakePoolData !== undefined) {
        //     this.stakePoolData(deactivateInstruction.params.stakePoolData);
        //   }
        //   if (deactivateInstruction.params.transferAuthorityAddress !== undefined) {
        //     this.transferAuthorityAddress(deactivateInstruction.params.transferAuthorityAddress);
        //   }
        // }
      }
    }
