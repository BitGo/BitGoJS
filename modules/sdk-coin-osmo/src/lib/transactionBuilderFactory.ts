...
export class TransactionBuilderFactory extends BaseTransactionBuilderFactory {
  ...
  getContractCallBuilder(tx?: CosmosTransaction): ContractCallBuilder {
    return this.initializeBuilder(tx, new ContractCallBuilder(this._coinConfig, osmoUtils));
  }

  getStakingRedelegateBuilder(tx?: CosmosTransaction): StakingRedelegateBuilder {
    return this.initializeBuilder(tx, new StakingRedelegateBuilder(this._coinConfig, osmoUtils));
  }
