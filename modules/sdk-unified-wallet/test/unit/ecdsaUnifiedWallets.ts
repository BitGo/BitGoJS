...
import { BitgoGPGPublicKey, common, KeychainsTriplet } from '@bitgo/sdk-core';
...
describe('EVM Wallets:', function () {
  ...
  describe('Generate EVM wallet:', function () {
    ...
    const keyTriplet: KeychainsTriplet = {
      userKeychain,
      bitgoKeychain,
      backupKeychain,
    };
    ...
    it('should correctly generate wallet', async function () {
      ...
      sandbox.stub(EcdsaEVMUnifiedWallets.prototype, 'generateKeychainsTriplet').resolves(keyTriplet);
