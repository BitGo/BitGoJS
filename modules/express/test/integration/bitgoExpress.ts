...
describe('Bitgo Express', function () {
  ...
  describe('verify address', function () {
    describe('failure', function () {
      it(
        'should mark as invalid bad btc address',
        co(function* () {
      ...
      it(
        'should mark as invalid bad ltc address',
        co(function* () {
          const res = yield agent
      ...
      it(
        'should mark as invalid bad tltc address',
        co(function* () {
          const res = yield agent
      ...
      it(
        'should mark as invalid bad tltc address when not allowing old script hash version',
        co(function* () {
          const res = yield agent
            .post('/api/v2/ltc/verifyaddress')
      ...
      it(
        'should mark as invalid bad eth address',
        co(function* () {
          const res = yield agent
      ...
      it(
        'should mark as invalid bad xrp address',
        co(function* () {
          const res = yield agent
    ...
    describe('success', function () {
      it(
        'should verify valid btc address',
        co(function* () {
          const res = yield agent
            .post('/api/v2/btc/verifyaddress')
      ...
      it(
        'should verify valid tbtc address',
        co(function* () {
          const res = yield agent
      ...
      it(
        'should verify valid ltc address',
        co(function* () {
          const res = yield agent
            .post('/api/v2/ltc/verifyaddress')
      ...
      it(
        'should verify old-style P2SH ltc address when allowing old script hash version',
        co(function* () {
          const res = yield agent.post('/api/v2/ltc/verifyaddress').send({
      ...
      it(
        'should verify valid eth address',
        co(function* () {
          const res = yield agent
            .post('/api/v2/eth/verifyaddress')
      ...
      it(
        'should verify valid xrp address',
        co(function* () {
          const res = yield agent
            .post('/api/v2/xrp/verifyaddress')
  ...
  describe('Request body size limits', () => {
    it(
      'should handle request bodies <=20mb',
      co(function* () {
    ...
    it(
      'should fail for request bodies >20mb',
      co(function* () {
        // actual number of bytes sent will be roughly 6x the number of bytes in
  ...
  it(
    'should not proxy a non-api route',
    co(function* () {
  ...
  it(
    'should proxy the oauth/token route',
    co(function* () {
  ...
  it(
    'should handle coinless routes with multiple query params',
    co(function* () {
  ...
  it(
    'should handle coinless routes with a single query param',
    co(function* () {
  ...
  describe('proxy error handling', () => {
    ...
    it(
      'should handle ECONNRESET errors from the proxy server',
      co(function* () {
