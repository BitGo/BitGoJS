...
describe('Generate Wallet Typed Routes Tests', function () {
  ...
  describe('Success Cases', function () {
    ...
    it('should decode and not forward userKeySigningRequired when omitted', async function () {
      const coin = 'tofc';
      const label = 'OFC Test Wallet';
      const enterprise = 'enterprise123';
      ...
      const mockWallet = {
        ...
        coin,
        label,
        toJSON: sinon.stub().returns({ id: 'ofcWallet456', coin, label }),
      };
      ...
      res.status.should.equal(200);
      generateWalletStub.should.have.been.calledOnce();
      generateWalletStub.firstCall.args[0].should.not.have.property('userKeySigningRequired');
    });
  });
