...
import {
  ...
  PostWalletSignTx,
} from '../../../src/typedRoutes/api/v2/walletSignTx';
...
describe('WalletSignTx codec tests', function () {
  describe('walletSignTx', function () {
    ...
    it('should successfully return a full transaction request (TxRequestResponse)', async function () {
      const requestBody = {
        txPrebuild: {
          txHex:
            '0100000001c7dad3d9607a23c45a6c1c5ad7bce02acff71a0f21eb4a72a59d0c0e19402d0f0000000000ffffffff0180a21900000000001976a914c918e1b36f2c72b1aaef94dbb7f578a4b68b542788ac00000000',
      ...
      // This ensures the transaction request response structure matches the typed definition
    ...
    describe('Error Cases', function () {
      ...
      it('should handle invalid coin error', async function () {
        ...
        // Make the request to Express
        const result = await agent
          .post(`/api/v2/${invalidCoin}/wallet/${walletId}/signtx`)
          .set('Authorization', 'Bearer test_access_token_12345')
          .set('Content-Type', 'application/json')
          .send(requestBody);
    ...
    describe('Edge Cases', function () {
      ...
      it('should handle very long wallet ID', async function () {
        ...
        const result = await agent
          .post(`/api/v2/${coin}/wallet/${veryLongWalletId}/signtx`)
          .set('Authorization', 'Bearer test_access_token_12345')
          .set('Content-Type', 'application/json')
          .send(requestBody);
      ...
      it('should handle wallet ID with special characters', async function () {
        ...
        const result = await agent
          .post(`/api/v2/${coin}/wallet/${encodeURIComponent(specialCharWalletId)}/signtx`)
          .set('Authorization', 'Bearer test_access_token_12345')
          .set('Content-Type', 'application/json')
          .send(requestBody);
  ...
  describe('WalletSignTxParams', function () {
    it('should validate params with required coin and id', function () {
      ...
      const decoded = assertDecode(t.type(WalletSignTxParams), validParams);
    ...
    it('should reject params with missing coin', function () {
      ...
      assert.throws(() => {
        assertDecode(t.type(WalletSignTxParams), invalidParams);
      });
    });
  ...
  describe('WalletTransactionPrebuild', function () {
    ...
    it('should reject prebuild with invalid field types', function () {
      ...
      assert.throws(() => {
        assertDecode(WalletTransactionPrebuild, invalidPrebuild);
      });
    });
  });

  describe('WalletSignTxBody', function () {
    ...
    it('should validate body with traditional wallet parameters', function () {
      const validBody = {
        prv: 'xprv9s21ZrQH143K3D8TXfvAJgHVfTEeQNW5Ys9wZtnUZkqPzFzSjbEJrWC1vZ4GnXCvR7rQL2UFX3RSuYeU9MrERm1XBvACow7c36vnz5iYyj2',
        txPrebuild: {
          txHex:
    ...
    it('should validate body with TSS wallet parameters', function () {
      const validBody = {
        walletPassphrase: 'my-secure-passphrase',
        txRequestId: 'tx-req-5a1341e7c8421dc90710673b3166bbd5',
        apiVersion: 'full',
    ...
    it('should validate body with multi-signature parameters', function () {
      const validBody = {
        prv: 'xprv9s21ZrQH143K3D8TXfvAJgHVfTEeQNW5Ys9wZtnUZkqPzFzSjbEJrWC1vZ4GnXCvR7rQL2UFX3RSuYeU9MrERm1XBvACow7c36vnz5iYyj2',
        txPrebuild: {
          txHex: '0100000001...',
    ...
    it('should validate body with gasLimit and gasPrice as different types', function () {
      ...
      const decoded1 = assertDecode(t.partial(WalletSignTxBody), validBody1);
      ...
      const decoded2 = assertDecode(t.partial(WalletSignTxBody), validBody2);
    ...
    it('should reject body with invalid apiVersion', function () {
      ...
      assert.throws(() => {
        assertDecode(t.partial(WalletSignTxBody), invalidBody);
      });
    });
  ...
  describe('Response Types', function () {
    ...
    describe('TxRequestResponse', function () {
      ...
      it('should validate response with optional fields for TSS wallets (Lite version)', function () {
        const validResponse = {
          txRequestId: '5a1341e7c8421dc90710673b3166bbd5',
          walletId: '5a1341e7c8421dc90710673b3166bbd5',
          walletType: 'hot',
  ...
  describe('PostWalletSignTx route definition', function () {
    ...
    it('should have the correct HTTP method', function () {
      assert.strictEqual(PostWalletSignTx.method, 'POST');
    });

    it('should have the correct request configuration', function () {
      assert.ok(PostWalletSignTx.request);
    });

    it('should have the correct response types', function () {
      assert.ok(PostWalletSignTx.response[200]);
      assert.ok(PostWalletSignTx.response[400]);
    });
  });
});
