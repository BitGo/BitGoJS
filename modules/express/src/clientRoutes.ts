 ...
 * @param req
 */
export async function handleWalletUpdate(req: express.Request): Promise<unknown> {
...
export function setupAPIRoutes(app: express.Application, config: Config): void {
  ...
  router.put('express.wallet.update', [prepareBitGo(config), typedPromiseWrapper(handleWalletUpdate as any)]);
