...
| N/A             | --externalSignerUrl | `BITGO_EXTERNAL_SIGNER_URL`                     | N/A             | Flag which permits making REST requests to an external signing API instead of using BitGo internal calls. |
