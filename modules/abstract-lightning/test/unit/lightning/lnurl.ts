...
describe('LNURL Functions', () => {
  ...
  describe('parseLightningInvoice', () => {
    ...
    it('should handle null millisatoshis in invoice', () => {
      // Mock bolt11.decode to return null millisatoshis
      const bolt11 = require('bolt11');
      const originalDecode = bolt11.decode;
      bolt11.decode = sinon.stub().returns({
        network: 'bitcoin',
        millisatoshis: undefined, // This happens for zero-amount invoices
        payeeNodeKey: 'node123abcdef',
        tags: [{ tagName: 'payment_hash', data: 'payhash123' }],
      });
      ...
      try {
        ...
        should(result).have.property('millisatoshis', null);
      } finally {
        bolt11.decode = originalDecode;
      }
    });
