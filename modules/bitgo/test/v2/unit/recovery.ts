  ...
  describe('Recover Stellar', function () {
    ...
    it('should generate XLM recovery tx', async function () {
      ...
      const recoveryParams = {
        ...
        walletPassphrase: bitgo.V2.TEST_RECOVERY_PASSCODE,
  ...
  describe('Recover ERC20', function () {
    it('should successfully construct a recovery transaction for tokens stuck in a wallet', async function () {
      ...
      const tx = await wallet.recoverToken({
        tokenContractAddress: bitgo.V2.TEST_ERC20_TOKEN_ADDRESS,
        recipient: bitgo.V2.TEST_ERC20_TOKEN_RECIPIENT,
        walletPassphrase: bitgo.V2.TEST_ETH_WALLET_PASSPHRASE,
      });
      ...
      txInfo.tokenContractAddress.should.equal(bitgo.V2.TEST_ERC20_TOKEN_ADDRESS);
      txInfo.should.have.property('walletId');
      txInfo.walletId.should.equal(bitgo.V2.TEST_ETH_WALLET_ID);
      txInfo.should.have.property('recipient');
      txInfo.recipient.should.have.property('address');
      txInfo.recipient.address.should.equal(bitgo.V2.TEST_ERC20_TOKEN_RECIPIENT);
    ...
    it('should successfully generate an ERC20 unsigned sweep', async function () {
      ...
      const transaction = await basecoin.recover({
        ...
        walletContractAddress: bitgo.V2.TEST_ETH_WALLET_FIRST_ADDRESS,
        tokenContractAddress: bitgo.V2.TEST_ERC20_TOKEN_ADDRESS,
        recoveryDestination: bitgo.V2.TEST_ERC20_TOKEN_RECIPIENT,
      });
      ...
      transaction.tokenContractAddress.should.equal(bitgo.V2.TEST_TDAI_TOKEN_ADDRESS);
      transaction.should.have.property('walletContractAddress');
      transaction.walletContractAddress.should.equal(bitgo.V2.TEST_ETH_WALLET_FIRST_ADDRESS);
      transaction.should.have.property('recipient');
      transaction.recipient.should.have.property('address');
      transaction.recipient.address.should.equal(bitgo.V2.TEST_ERC20_TOKEN_RECIPIENT);
