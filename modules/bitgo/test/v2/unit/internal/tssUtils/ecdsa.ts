...
describe('TSS Ecdsa Utils:', async function () {
  ...
  it('getUncompressedPublicKeyFromCommonKeychain returns correct public key', function () {
    ...
    const actualPubKey = ECDSAUtils.EcdsaUtils.getUncompressedPublicKeyFromCommonKeychain(commonKeychain);
