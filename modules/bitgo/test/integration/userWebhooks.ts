...
describe('User Webhooks:', function () {
  ...
  describe('Create', function () {
    it(
      'should fail to create a new webhook with missing params',
      co(function* () {
        try {
  ...
  describe('List', function () {
    it(
      'should fetch list of user webhooks',
      co(function* () {
  ...
  describe('Simulate', function () {
    it(
      'should fail to simulate a block webhook with missing params',
      co(function* () {
        try {
    ...
    it(
      'should simulate a block webhook',
      co(function* () {
  ...
  describe('List notifications', function () {
    it(
      'should fetch list of webhook notifications',
      co(function* () {
  ...
  describe('Remove', function () {
    it(
      'should fail to remove a webhook with missing params',
      co(function* () {
        try {
