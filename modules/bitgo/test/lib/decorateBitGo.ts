...
import { BitGoOptions } from 'modules/bitgo/src';
nock.enableNetConnect();

export interface TestableBG {
  new (args: BitGoOptions): BitGoAPI
...
export function decorateBitGo<T extends { new (...args: any[]): InstanceType<T>}, U extends TestableBG & InstanceType<T>>(_bitgo: T, args?: BitGoAPIOptions): U {
