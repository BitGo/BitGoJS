...
describe('V2 Wallet:', function () {
  ...
  describe('Create Address', function () {
    ...
    it(
      'should create a new address from a listed wallet',
      co(function* () {
    ...
    it(
      'should create new addresses in bulk',
      co(function* () {
    ...
    it(
      'should set gas price for a new address',
      co(function* () {
  ...
  describe('List Transactions', function () {
    ...
    it(
      'should fail if not given a txHash',
      co(function* () {
        try {
    ...
    it(
      'should fail if limit is negative',
      co(function* () {
        try {
          yield wallet.getTransaction({
  ...
  describe('List Transfers', function () {
    ...
    it(
      'transfers with limit and nextBatchPrevId',
      co(function* () {
  ...
  describe('Prebuild Transactions', () => {
    it(
      'should retrieve offline verification data for transaction prebuilds, if requested',
      co(function* () {
  ...
  describe('Send Transactions', function () {
    ...
    it(
      'should send transaction with sequence Id',
      co(function* () {
    ...
    it(
      'should fetch a transfer by its sequence Id',
      co(function* () {
    ...
    it(
      'sendMany should error when given a non-array of recipients',
      co(function* () {
        const recipientAddress = yield wallet.createAddress();
        const params = {
          recipients: {
    ...
    it(
      'should prebuild a transaction to the wallet',
      co(function* () {
        const recipientAddress = yield wallet.createAddress();
        const params = {
          recipients: [
  ...
  xdescribe('Sharing & Pending Approvals', function () {
    ...
    it(
      'should share a wallet and then resend the wallet invite',
      co(function* () {
        // share this wallet
  ...
  describe('Policies', function () {
    ...
    it(
      'should create a velocity limit policy and then remove it',
      co(function* () {
  ...
  describe('Unspent Manipulation', function () {
    xit(
      'should consolidate the number of unspents to 2, and fanout the number of unspents to 200',
      co(function* () {
    ...
    xit(
      'should sweep funds between two wallets',
      co(function* () {
        const unspentWallet = yield wallets.getWallet({ id: TestBitGo.V2.TEST_WALLET2_UNSPENTS_ID });
