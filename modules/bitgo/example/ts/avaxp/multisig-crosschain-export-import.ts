...
const main = async (): Promise<any> => {
  ...
  const avaxPrivateKey = 'PrivateKey-e2PZP3FYBU3G3gkRXXZkYPtye2ZqFrbSA13uDiutLK5ercixX';

  // paste your BitGo P-chain receive addresses here like:
  const pAddressesStrings = ['P-fuji1dt2djgfjak73yzcnppg9h7vxz0jp77rs7l7rta', 'P-fuji1rp8nu6fw4926e9tk2y4xwe0p63m6xxtn0ysrja', 'P-fuji173dqcnprmcdp3ryj7wqpmherhvntv57hskw6f7'];
  ...
  const utxos: UTXO[] = [utxoSet.getAllUTXOs()[0]];
