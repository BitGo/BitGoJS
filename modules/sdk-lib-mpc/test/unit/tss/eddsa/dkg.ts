...
import { DKG, fetchMaterial } from '../../../../src/tss/eddsa-dkls';
...
describe('EdDSA DKLS DKG', function () {
  ...
  describe('DKG Protocol Execution', function () {
    ...
    it('should generate consistent key shares across all parties', async function () {
      ...
      const keyShareData = fetchMaterial([userKeyShare, backupKeyShare, bitgoKeyShare]);
  ...
  describe('Seed-based Key Generation', function () {
    it('should create key shares with deterministic seeds', async function () {
      ...
      // Verify all parties have the same public key
      const [userKeyData, backupKeyData, bitgoKeyData] = fetchMaterial([userKeyShare, backupKeyShare, bitgoKeyShare]);
      ...
      const [userKeyShare2, backupKeyShare2, bitgoKeyShare2] = fetchMaterial([
        user2.getKeyShare(),
        backup2.getKeyShare(),
        bitgo2.getKeyShare(),
      ]);
