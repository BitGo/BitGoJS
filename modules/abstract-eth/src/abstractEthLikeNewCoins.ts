...
export abstract class AbstractEthLikeNewCoins extends AbstractEthLikeCoin {
  ...
  static getCustomChainCommon(chainId: number): EthLikeCommon.default {
    const coinName = EthLikeCoinNameFromChainId[chainId];
   ...
   * @param params {BuildTransactionParams}
   * @returns
   */
   ...
   * @param address {String} the ETHLike address
   ...
   * @param contractSequenceId {number}
   * @returns {string}
   */
