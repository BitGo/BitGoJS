...
describe('TSS EDDSA key generation and signing', () => {
  it('should generate keys and sign message', async () => {
    ...
    // const A_sign_share = await Eddsa.signShare(message_buffer, [A_combine[1], A_combine[2]]);
    // const B_sign_share = await Eddsa.signShare(message_buffer, [B_combine[1], B_combine[2]]);
