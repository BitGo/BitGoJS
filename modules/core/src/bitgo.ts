...
BitGo.prototype.fromJSON = function(json) {
  ...
  if (json.extensionKey) {
    this._extensionKey = bitcoin.ECPair.fromWIF(json.extensionKey, bitcoin.networks[common.getNetwork()]);
  }
};
...
BitGo.prototype.instantGuarantee = function(params, callback) {
  ...
  .then(function(body) {
    ...
    const prefix = bitcoin.networks[common.getNetwork()].messagePrefix;
