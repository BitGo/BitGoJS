  ...
  describe('validate txBuilder fields', () => {
    ...
    it('should fail amount low than zero', () => {
      assert.throws(
        ...
        (e: Error) => e.message === errorMessage.ERROR_AMOUNT
      );
    });
    it('should fail target chain id length incorrect', () => {
      assert.throws(
        ...
        (e: Error) => e.message === errorMessage.ERROR_CHAIN_ID_LENGTH
      );
    });
    ...
    it('should fail target chain id not a vaild base58 string', () => {
      assert.throws(
        ...
        (e: Error) => e.message === errorMessage.ERROR_CHAIN_ID_NOT_BASE58
      );
    });
    ...
    it('should fail target chain id cb58 invalid checksum', () => {
      assert.throws(
        ...
        (e: Error) => e.message === errorMessage.ERROR_CHAIN_ID_INVALID_CHECKSUM
      );
    });
