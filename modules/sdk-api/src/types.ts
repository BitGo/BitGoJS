...
export interface AuthenticateOptions {
   ...
   * This hash is generated based on unique device attributes such as OS, device model, app info,
   * runtime environment, and a UUID. It is securely stored and used as a reference for further
   * fingerprint validation processes.
   * @type {string}
   * @default undefined
   * @description An SHA-256 hash string generated from device-specific attributes, ensuring
   * consistent and secure identification of the device.
   */
  initialHash?: string;
  /**
   * The final stage fingerprint hash used for trusted device verification.
   * This hash is generated by combining the initialHash with a user-provided verification code.
   * It is securely stored and used for authenticating trusted devices during login.
   * @type {string}
   * @default undefined
   * @description An SHA-256 hash string derived from the initialHash and verification code,
   * ensuring secure and unique identification of the device.
   */
