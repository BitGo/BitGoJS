...
//
// }
Wallets.prototype.createWalletWithKeychains = async function (params, callback) {
  params = params || {};
  ...
  userKeychain.encryptedXprv = await this.bitgo.encryptAsync({ password: params.passphrase, input: userKeychain.xprv });
