...
export abstract class NativeTransferBuilder extends TransactionBuilder {
   ...
   */
  // THIS METHOD WILL BE OVERRIDEN IF FOR SOME RESAON THE PARACHAIN NATIVE ASSET TRANSFER IS DIFFERENT
  ...
  protected fromImplementation(rawTransaction: string): Transaction {
    ...
    if (this._method?.name === MethodNames.TransferKeepAlive || this._method?.name === MethodNames.Transfer) {
