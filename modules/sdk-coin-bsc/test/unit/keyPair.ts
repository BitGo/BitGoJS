...
import { TEST_ACCOUNT } from '../resources/bsc';

describe('BSC Key Pair', () => {
  describe('should create a valid KeyPair', () => {
    it('from no source object', () => {
