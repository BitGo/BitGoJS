...
/**
 * BSC Keys and Address Management
 */
export class KeyPair extends Secp256k1ExtendedKeyPair {
  ...
  /**
   * BSC default keys format is the same as ethereum: raw private and uncompressed public key
   *
  ...
  /**
   * Get a BSC public address in ethereum format
   *
