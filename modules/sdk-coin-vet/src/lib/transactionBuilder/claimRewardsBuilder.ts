  ...
  protected isValidTransactionClauses(clauses: TransactionClause[]): boolean {
    try {
      ...
      for (const clause of clauses) {
        ...
        const isDelegationContract = clause.to.toLowerCase() === STARGATE_DELEGATION_ADDRESS.toLowerCase();
        const isNftContract = clause.to.toLowerCase() === STARGATE_NFT_ADDRESS.toLowerCase();
