...
import { BURN_NFT_METHOD_ID, STARGATE_NFT_ADDRESS } from '../../src/lib/constants';
...
describe('Vet Burn NFT Transaction', () => {
  ...
  describe('Build and Sign', () => {
    it('should build a burn NFT transaction', async function () {
      ...
      txBuilder.nftContract(); // Use default address
      txBuilder.gas(21000);
      ...
      should.equal(tx.contract, STARGATE_NFT_ADDRESS);
      ...
      should.equal(tx.clauses[0].to, STARGATE_NFT_ADDRESS);
    ...
    it('should deserialize and reserialize a signed burn NFT transaction', async function () {
      ...
      should.equal(deserializedTx.contract, STARGATE_NFT_ADDRESS);
    });
