...
import { DeserializedNTilde, NTildeProof, RSAModulus, RangeProof, RangeProofWithCheck } from './types';
 ...
 * @returns {DeserializedNTilde} The generated DeserializedNTilde values.
 */
 ...
 * @returns {NTildeProof} The generated DeserializedNTilde Proofs.
 */
...
export async function verifyNtildeProof(
  ntilde: DeserializedNTilde,
  ntildeProof: NTildeProof<bigint>
): Promise<boolean> {
 ...
 * @param {DeserializedNTilde} ntilde The verifier's DeserializedNTilde values.
