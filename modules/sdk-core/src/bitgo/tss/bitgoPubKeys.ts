...
export const bitgoMpcGpgPubKeys = {
  mpcv1: {
    ...
    onprem: {
      test: '-----BEGIN PGP PUBLIC KEY BLOCK-----\n\\nIhIxl81/wqAgqigIblrz6vjtagr9/ykXQCW3\n=skCo\n-----END PGP PUBLIC KEY BLOCK-----\n',
      prod: '-----BEGIN PGP PUBLIC KEY BLOCK-----\n\\n6Q89TGR2QftpckwcUTKON9puGe9+ulan\n=OqZu\n-----END PGP PUBLIC KEY BLOCK-----\n',
    },
  },
  mpcv2: {
    nitro: {
    ...
    onprem: {
      test: '-----BEGIN PGP PUBLIC KEY BLOCK-----\n' +
    '\n' +
    'xk8EaQHolxMFK4EEAAoCAwR4tVjUxsZxoRBwQ1fViFwkNYc3o726fbocFuRC\n' +
    '7VFMLWA7ePpv5jWW3UciFfpZl7rLthRyjtvPrLEHnFO1UIKvzVUzNjE4MDQx\n' +
    'ZTg1ZTNkZGVlNDVhZjNhMTUgPHVzZXItMzYxODA0MWU4NWUzZGRlZTQ1YWYz\n' +
    'YTE1QDM2MTgwNDFlODVlM2RkZWU0NWFmM2ExNS5jb20+wowEEBMIAD4FgmkB\n' +
    '6JcECwkHCAmQ3VOwPJ/DfjEDFQgKBBYAAgECGQECmwMCHgEWIQSIAQgccl1i\n' +
    'WjWnBzbdU7A8n8N+MQAAuPIBANuYe3Vaq4dyegHV6ByFDcJ4fT92Da3KZaVd\n' +
    'SYfJ3Wv1AQCVgHWv0WBEMWeD8Sbe4ouzEJcVeyA3o6tRtKTBwlkCoc5TBGkB\n' +
    '6JcSBSuBBAAKAgMEhzPXBoXDC7/MAbGLBvG0zAM9bt9bAUkWokf+h5Hquhyd\n' +
    '8stIJdacIma38w6jq+WMIvr/v0+2OewXQs9ieI1mqQMBCAfCeAQYEwgAKgWC\n' +
    'aQHolwmQ3VOwPJ/DfjECmwwWIQSIAQgccl1iWjWnBzbdU7A8n8N+MQAAhzUB\n' +
    'AJNr19CJRdACn96dhOuF7uxk5eb/1KnPVXXsOjHvbqdCAQDPUkq6LbpFc9Ok\n' +
    'hLZlkAl+8bbMRI3YGjouzxDVCMiyxQ==\n' +
    '=jZ7I\n' +
    '-----END PGP PUBLIC KEY BLOCK-----\n',
