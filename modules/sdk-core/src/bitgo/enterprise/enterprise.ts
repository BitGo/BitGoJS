...
export class Enterprise implements IEnterprise {
  ...
  async initiateChallengesForEcdsaSigning(userPassword: string): Promise<void> {
    await EcdsaUtils.initiateChallengesForEnterprise(this.bitgo, this.id, userPassword);
  }
}
