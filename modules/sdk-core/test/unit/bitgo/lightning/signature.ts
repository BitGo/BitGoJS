...
describe('verifySignature', function () {
  const key: utxolib.BIP32Interface = utxolib.testutil.getKey('key');
  const keyPub: utxolib.BIP32Interface = key.neutered();
  const wrongKey: utxolib.BIP32Interface = utxolib.testutil.getKey('wrongKey');
