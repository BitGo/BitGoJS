...
export interface FlrTransactionParams extends TransactionParams {
  gasPrice?: number;
  gasLimit?: number;
  hopParams?: HopParams;
  hop?: boolean;
...
export interface VerifyFlrTransactionOptions extends VerifyTransactionOptions {
  txPrebuild: TransactionPrebuild;
  txParams: FlrTransactionParams;
}
...
// Replace Eth.HopPrebuild with Flr.HopPrebuild
...
export interface FlrSignTransactionOptions extends BaseSignTransactionOptions {
