...
export class AssetTransferBuilder extends TransferBuilder {
   ...
   *
   * This method sets the assetIndex, sender, receiver, asset amount, and
  ...
  private validateFields(assetIndex: number, assetAmount: number | bigint, receiver: string): void {
