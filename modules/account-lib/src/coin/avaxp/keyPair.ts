...
import { KeyPairOptions, isPrivateKey, isPublicKey, isSeed, DefaultKeys } from '../../coin/baseCoin/iface';
import { Secp256k1ExtendedKeyPair } from '../../coin/baseCoin/secp256k1ExtendedKeyPair';
