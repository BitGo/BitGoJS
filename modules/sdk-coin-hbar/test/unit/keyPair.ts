...
describe('Hedera Key Pair', () => {
  ...
  describe('should fail to create a KeyPair', () => {
    ...
    it('from an invalid private key', () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === testData.errorMessageOddLengthOrNonHexPrivateKey
      );
      assert.throws(
  ...
  describe('should fail to get address ', () => {
    it('from a private key', () => {
      ...
      assert.throws(
        () => keyPair.getAddress(),
        (e: Error) => e.message === testData.errorMessageNotPossibleToDeriveAddress
      );
    });
  ...
  describe('should fail sign ', () => {
    it('a message without a private key', () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === testData.errorMessageMissingPrivateKey
      );
    });
  });
});
