 ...
 *
 * Uses Blake2b-256. All integer fields are little-endian.
 */
...
export function computeKaspaSigningHash(
  ...
  // Build the preimage
  // version(2) + prevOutputsHash(32) + seqHash(32) + sigOpHash(32)
  // + txId(32) + outIdx(4) + spkVersion(2) + spkLen(8) + spkBytes(n)
  // + value(8) + sequence(8) + sigOpCount(1)
  // + outsHash(32) + locktime(8) + subnetId(20) + gas(8) + payloadHash(32) + sigHashType(1)
  ...
  // 16. gas (u64 LE) — always 0 for native KAS
