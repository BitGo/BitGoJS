  ...
  describe('Address Validation', () => {
    ...
    it('should validate wallet receive address', async function () {
      const receiveAddress = {
        address: 'mantra1897xa4swxx9dr7z0zut0mfs7efplx80q86kd8q?memoId=7',
        coinSpecific: {
          rootAddress: 'mantra1897xa4swxx9dr7z0zut0mfs7efplx80q86kd8q',
          memoID: '7',
        },
      };
  ...
  describe('Verify transaction: ', () => {
    ...
    it('should succeed to verify sendMany transaction', async function () {
      ...
      const txParams = {
        recipients: [
          {
            address: 'mantra19syhqw5qeuas365cw9pvdadzex7durfm7hlfn8',
            amount: '10000',
          },
          {
            address: 'mantra1c9npt0xhwfvmtnhyq3jqfhq0889l8w04qay3ds',
            amount: '10000',
          },
        ],
      };
