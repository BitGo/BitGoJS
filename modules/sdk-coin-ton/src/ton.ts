...
export class Ton extends BaseCoin {
  ...
  // getTonClient() {
  //   return new TonWeb(new TonWeb.HttpProvider(this.getPublicNodeUrl()));
  // }
  ...
  async recover(params: MPCRecoveryOptions): Promise<MPCTx | MPCSweepTxs> {
    ...
    const PRIVATE_KEY_1 = '43e8594854cb53947c4a1a2fab926af11e123f6251dcd5bd0dfb100604186430';
    const prvKey1 = PRIVATE_KEY_1;
    const feeEstimate = await wallet.methods
      .transfer({
        secretKey: tonweb.utils.stringToBytes(prvKey1), // using a dummy private key to estimate fee
