...
import { script as bscript, networks as BNETWORKS } from 'bitcoinjs-lib';
...
export function equate(a: any, b: any, args?: any): void {
  ...
  if ('controlBlock' in b) t.strictEqual(tryHex(a.controlBlock), tryHex(b.controlBlock), 'Inequal control block');
  if ('annex' in b) {
