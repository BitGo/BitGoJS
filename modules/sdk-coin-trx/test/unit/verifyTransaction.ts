      ...
      it('should validate valid TransferContract', async function () {
        ...
        const transferContract = {
          parameter: {
            value: {
              amount: 1000000,
              owner_address: Utils.getBase58AddressFromHex('4173a5993cd182ae152adad8203163f780c65a8aa5'),
              to_address: Utils.getBase58AddressFromHex('41d6cd6a2c0ff35a319e6abb5b9503ba0278679882'),
            },
      ...
      it('should fail with missing owner address', async function () {
        ...
        const transferContract = {
          parameter: {
            value: {
              amount: 1000000,
              to_address: Utils.getBase58AddressFromHex('41c25420255c2c5a2dd54ef69f92ef261e6bd4216a'),
            },
            type_url: 'type.googleapis.com/protocol.TransferContract',
          },
          type: 'TransferContract',
      ...
      it('should fail due to destination address missmatch', async function () {
        ...
        const params = {
          txParams: {
            recipients: [
              {
                address: Utils.getBase58AddressFromHex('41d6cd6a2c0ff35a319e6abb5b9503ba0278679883'),
                amount: '1000000',
              },
            ],
          },
