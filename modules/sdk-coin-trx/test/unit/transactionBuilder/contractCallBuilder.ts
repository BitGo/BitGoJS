    ...
    describe('should fail to build', () => {
      it('a transaction with wrong data', async () => {
        ...
        assert.throws(
          ...
          (e: Error) => e.message === 'addMintRequest() is not a valid hex string.'
        );
      });
      ...
      it('a transaction with duplicate signatures', async () => {
        ...
        assert.throws(
          ...
          (e: Error) => e.message === 'Duplicated key'
        );
        const tx = await txBuilder.build();
      ...
      it('an invalid raw transaction', () => {
        assert.throws(
          ...
          (e: Error) => e.message === 'There was error in parsing the JSON string'
        );
      });
    });
  });
  ...
  describe('Should validate ', () => {
    ...
    it('an expiration greater than one year', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'Expiration must not be greater than one year'
      );
    });
    ...
    it('an expiration less than the current date', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'Expiration must be greater than current time'
      );
    });
    ...
    it('an expiration less than the timestamp', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'Expiration must be greater than timestamp'
      );
    });
    ...
    it('an expiration set after build', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'Expiration is already set, it can only be extended'
      );
    });
    ...
    it('an extension without a set expiration', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'There is not expiration to extend'
      );
    });
    ...
    it('a zero millisecond extension', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'Value cannot be below zero'
      );
    });
    ...
    it('an extension grater than one year', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'The expiration cannot be extended more than one year'
      );
    });
    ...
    it('an extension after signing', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'Cannot extend a signed transaction'
      );
    });
    ...
    it('fee limit', async () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'Invalid fee limit value'
      );
