  ...
  describe('Should validate ', () => {
    ...
    it('an empty address', () => {
      assert.throws(
        ...
        (e: Error) => e.message === ' is not a valid base58 address.'
      );
    });
    ...
    it('a hex address', () => {
      assert.throws(
        ...
        (e: Error) => e.message === '4173a5993cd182ae152adad8203163f780c65a8aa5 is not a valid base58 address.'
      );
    });
    ...
    it('a value too big', () => {
      ...
      assert.throws(
        ...
        (e: Error) => e.message === 'Value cannot be greater than handled by the javatron node.'
      );
    });
  });
});
