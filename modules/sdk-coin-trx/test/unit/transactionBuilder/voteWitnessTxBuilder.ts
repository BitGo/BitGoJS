...
import { VoteWitnessTxBuilder } from '../../../src/lib/voteWitnessTxBuilder';
import { validVoteUnsignedTx } from '../../resources';
import { getBuilder } from '../../../src/lib/builder';
import { WrappedBuilder } from '../../../src/lib/wrappedBuilder';

describe('Tron VoteBuilder', function () {
  let voteBuilder: VoteWitnessTxBuilder;
  let wrappedBuilder: WrappedBuilder;

  before(() => {
    wrappedBuilder = getBuilder('ttrx') as WrappedBuilder;
    voteBuilder = wrappedBuilder.getVoteWitnessTxBuilder();
  });
