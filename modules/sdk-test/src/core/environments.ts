 ...
 */
/**
 * This is a duplicate of environments.ts in sdk-core/src/bitgo/environments.ts
 * to avoid adding sdk-core as a dependency of sdk-test.
 * sdk-core will later use sdk-test to migrate test from bitgo so this is to
