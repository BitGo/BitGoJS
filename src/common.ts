...
export = {
  ...
  getRmgNetwork: function() {
    return rmgNetwork;
  },
  setRmgNetwork: function(network) {
    rmgNetwork = network;
  },
  setEthNetwork: function() {
    ethereumNetwork = 'ethereum';
  },
  getEthNetwork: function() {
   ...
   */
  validateParams: function(params, expectedParams, optionalParams?, optionalCallback?) {
