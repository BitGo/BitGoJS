...
ec.ECPointFp.decodeFrom = function (curve, enc) {
  var type = enc[0];
...
ec.ECPointFp.prototype.toString = function () {
 ...
 */
ec.ECPointFp.prototype.validate = function () {
  var n = this.curve.getQ();
