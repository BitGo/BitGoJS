...
COPY --from=builder /tmp/bitgo/modules/sdk-coin-kava /var/modules/sdk-coin-kava/
...
cd /var/modules/sdk-coin-kava && yarn link && \
...
#LABEL_START
LABEL created="Mon, 11 Sep 2023 15:47:54 GMT"
LABEL version=9.39.1
LABEL git_hash=3fad44186dbab998e5faaefbdedb806cbac4858b
#LABEL_END
