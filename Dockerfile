...
COPY --from=builder /tmp/bitgo/modules/sdk-coin-solayer /var/modules/sdk-coin-solayer/
...
cd /var/modules/sdk-coin-solayer && yarn link && \
...
RUN cd /var/bitgo-express && \
    ...
    yarn link @bitgo/sdk-coin-solayer && \
