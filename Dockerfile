...
COPY --from=builder /tmp/bitgo/modules/lightning-lib /var/modules/lightning-lib/
...
cd /var/modules/lightning-lib && yarn link && \
...
#LABEL_START
LABEL created="Fri, 21 Jun 2024 16:12:43 GMT"
LABEL version=10.0.3
LABEL git_hash=3dc1c7f4259742c3a4c6ad73ace77a8e2e3db1c8
#LABEL_END
